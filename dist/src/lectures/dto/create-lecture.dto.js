...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Lecture title', example: 'Introduction to CS', minLength: 1 }),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateLectureDto.prototype, "title", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Display order (non-negative integer)', example: 0, minimum: 0 }),
